...
void LogInTable(){//登录界面
    ...
    textInput1->setPlaceholderText("请输入用户名");
    ...
    textInput2->setPlaceholderText("请输入密码");
    ...
    //
    QPushButton *button1 = new QPushButton("登录",Login_Window);
    button1->setFixedSize(260,37);
    button1->setStyleSheet("color: white; background: rgba(255,255,255,0);");

    QPushButton *button2 = new QPushButton("注册",Login_Window);
...
void RegisterTable(){
    ...
    QPushButton *button1 = new QPushButton("确认",Register_Window);
    button1->setFixedSize(260,37);
    button1->setStyleSheet("color: white; background: rgba(255,255,255,0);");
