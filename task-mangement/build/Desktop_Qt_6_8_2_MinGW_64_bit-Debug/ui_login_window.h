...
public:
    ...
    void setupUi(QWidget *Login_window)
    {
        ...
        Login_window->resize(521, 481);
        Login_window->setStyleSheet(QString::fromUtf8(""));
        frame = new QFrame(Login_window);
...
"border-image:url(:/images/login2.png);\n"
"\n"
"}"));
        ...
        textInput1->setGeometry(QRect(160, 143, 221, 41));
...
"    }"));
        ...
        textInput2->setGeometry(QRect(160, 200, 221, 41));
...
"        color: #777;\n"
"    }"));
        textInput2->setEchoMode(QLineEdit::EchoMode::Password);
...
"    }"));
        ...
        pushButton->setGeometry(QRect(390, 208, 51, 21));
...
"    }"));
        ...
        label->setGeometry(QRect(220, 40, 201, 51));
...
"		font-size:23px;"));
    ...
    {
        Login_window->setWindowTitle(QCoreApplication::translate("Login_window", "PKU TimeManagement Master/login", nullptr));
        textInput1->setPlaceholderText(QCoreApplication::translate("Login_window", "\350\257\267\350\276\223\345\205\245\347\224\250\346\210\267\345\220\215", nullptr));
        textInput2->setPlaceholderText(QCoreApplication::translate("Login_window", "\350\257\267\350\276\223\345\205\245\345\257\206\347\240\201", nullptr));
        button1->setText(QCoreApplication::translate("Login_window", "\347\231\273\345\275\225", nullptr));
        button2->setText(QCoreApplication::translate("Login_window", "\346\263\250\345\206\214", nullptr));
        pushButton->setText(QCoreApplication::translate("Login_window", "\346\230\276\347\244\272\345\257\206\347\240\201", nullptr));
        label->setText(QCoreApplication::translate("Login_window", "PKU\346\227\266\351\227\264\347\256\241\347\220\206\345\244\247\345\270\210", nullptr));
    } // retranslateUi
